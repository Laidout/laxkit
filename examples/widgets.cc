...
//	app.addwindow(isel);
	...
	//------------------- StackFrame --------------------------
	StackFrame *stack = new StackFrame(nullptr, "StackFrame","StackFrame", ANXWIN_CENTER /* STACKF_VERTICAL for vertical */,
		0,0, 600,200, 0,
		nullptr,0,nullptr,
		15 //int ngap
		);
	stack->AddWin(new MessageBar(nullptr, "mbar1",nullptr, 0, 0,0,100,100,1, "One"),1);
	stack->AddWin(new MessageBar(nullptr, "mbar2",nullptr, 0, 0,0,100,100,1, "Two"),1);
	stack->AddWin(new MessageBar(nullptr, "mbar3",nullptr, 0, 0,0,100,100,1, "Three"),1);
	stack->HideSubBox(2);
	stack->HideSubBox(0);
	app.addwindow(stack);
